...
```
theia@theia-u11203041:/home/project$ tar -cvf bin.tar /bin
...
/bin/lessfile
/bin/lessecho
theia@theia-u11203041:/home/project$ ls /bin/tar
/bin/tar
theia@theia-u11203041:/home/project$ tar -tvf bin.tar
drwxr-xr-x root/root         0 2023-09-16 06:43 bin/
...
-rwxr-xr-x root/root    423312 2023-02-15 09:55 bin/tar
...
theia@theia-u11203041:/home/project$ tar -x bin.tar
tar: Refusing to read archive contents from terminal (missing -f option?)
tar: Error is not recoverable: exiting now
theia@theia-u11203041:/home/project$ tar -xvf bin.tar
bin/
bin/zdiff
bin/su
bin/more
...
total 5628
drwxr-sr-x 2 theia users    4096 Sep 16 06:43 bin
-rw-r--r-- 1 theia users 5703680 Sep 16 08:34 bin.tar
...
theia@theia-u11203041:/home/project$ zip config.zip /etc/*.conf
...
theia@theia-u11203041:/home/project$ zip -r bin.zip /bin
  adding: bin/ (stored 0%)
...
theia@theia-u11203041:/home/project$ unzip -l config.zip
Archive:  config.zip
  Length      Date    Time    Name
---------  ---------- -----   ----
     3028  2023-01-26 03:31   etc/adduser.conf
     6153  2023-09-16 06:40   etc/ca-certificates.conf
